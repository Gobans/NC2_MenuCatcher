...
final class Sqlite {
    ...
    let FoodCategory: [String] = [
        "과일 채소음료류", "과자류", "구이류", "국 및 탕류", "기타 빵류", "기타 음료류", "도넛류", "면 및 만두류", "밥류", "버거류", "볶음류", "샌드위치류", "생채및 무침류", "스무디류", "식빵류", "아이스크림류", "전 적 및 부침류", "조림류", "찌개 및 전골류", "찜류", "차류", "커피류", "케이크류", "크림빵류", "탄산음료류", "튀김류", "페이스트리류", "피자류"
    ]
